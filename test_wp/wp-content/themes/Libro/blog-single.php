          ...
          <div class="row d-flex justify-content-end">
            <div class="col-md-12 px-5">
              <ul class="mb-5">
                ...
                <li class="active"><a href="fashion.php"><span>Fashion</span></a></li>
      ...
      <section class="ftco-fixed clearfix">
		          ...
		          <div class="container">
		            <div class="row slider-text align-items-end" data-scrollax-parent="true">
		              <div class="col-md-10 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		              	<p class="breadcrumbs"><span><a href="../../../index.php">Home</a></span> <span>Blog</span></p>
      	...
      	<div class="page-container float-right">
            ...
            <div class="col-md-12">
              ...
              <p>
                <img src="images/image_6.png" alt="" class="img-fluid">
              </p>
              ...
              <p>
                <img src="images/image_8.png" alt="" class="img-fluid">
              </p>

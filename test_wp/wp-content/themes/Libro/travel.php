      		...
      		<div class="row">
      			<div class="col-md-12">
      				<div class="blog-entry-4 d-flex ftco-animate">
      					<a href="blog-single.php" class="blog-img" style="background-image: url(images/image_11.png);">
	      				</a>
	      				<div class="text">
      				...
      				<div class="blog-entry-4 d-flex ftco-animate">
      					<a href="blog-single.php" class="blog-img" style="background-image: url(images/image_2.png);">
	      				</a>
	      				<div class="text">
	      					<h3 class="mb-4">The Big Oxmox advised her not to do so, because there</h3>
	      					<p class="meta">
      				...
      				<div class="blog-entry-4 d-flex ftco-animate">
      					<a href="blog-single.php" class="blog-img" style="background-image: url(images/image_3.png);">
	      				</a>
	      				<div class="text">
	      					<h3 class="mb-4">The Big Oxmox advised her not to do so, because there</h3>
	      					<p class="meta">
      				...
      				<div class="blog-entry-4 d-flex ftco-animate">
      					<a href="blog-single.php" class="blog-img" style="background-image: url(images/image_4.png);">
	      				</a>
	      				<div class="text">
	      					<h3 class="mb-4">The Big Oxmox advised her not to do so, because there</h3>
	      					<p class="meta">
      				...
      				<div class="blog-entry-4 d-flex ftco-animate">
      					<a href="blog-single.php" class="blog-img" style="background-image: url(images/image_5.png);">
	      				</a>
	      				<div class="text">
	      					<h3 class="mb-4">The Big Oxmox advised her not to do so, because there</h3>
	      					<p class="meta">
      				...
      				<div class="blog-entry-4 d-flex ftco-animate">
      					<a href="blog-single.php" class="blog-img" style="background-image: url(images/image_6.png);">
	      				</a>
	      				<div class="text">
	      					<h3 class="mb-4">The Big Oxmox advised her not to do so, because there</h3>
	      					<p class="meta">
      				...
      				<div class="blog-entry-4 d-flex ftco-animate">
      					<a href="blog-single.php" class="blog-img" style="background-image: url(images/image_7.png);">
	      				</a>
	      				<div class="text">
	      					<h3 class="mb-4">The Big Oxmox advised her not to do so, because there</h3>
	      					<p class="meta">
      				...
      				<div class="blog-entry-4 d-flex ftco-animate">
      					<a href="blog-single.php" class="blog-img" style="background-image: url(images/image_8.png);">
	      				</a>
	      				<div class="text">
	      					<h3 class="mb-4">The Big Oxmox advised her not to do so, because there</h3>
	      					<p class="meta">
